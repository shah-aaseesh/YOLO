    ...
    <div className="relative min-h-[500px] md:h-[650px] w-full overflow-hidden bg-gray-900 flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl text-center md:text-left mx-auto md:mx-0">
          ...
          <p className="text-base md:text-xl text-white/90 mb-8 max-w-2xl mx-auto md:mx-0 font-medium leading-relaxed">
            Stop waiting for tomorrow. Embark on a journey of a lifetime with YOLO's curated Himalayan experiences.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            <button className="w-full sm:w-auto bg-[#f58220] text-white px-8 py-4 rounded-full font-black hover:bg-[#d8731b] transition-all uppercase tracking-widest text-xs shadow-2xl shadow-orange-500/30">
              Get Started
            </button>
            <button className="w-full sm:w-auto bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-full font-black hover:bg-white hover:text-gray-900 transition-all uppercase tracking-widest text-xs">
              Our Packages
            </button>
          </div>
        </div>
