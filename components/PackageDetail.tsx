    ...
    <div className="bg-white pb-24">
      ...
      <div className="relative h-[300px] md:h-[450px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
          <span className="text-white text-sm md:text-base font-black uppercase tracking-[0.4em] mb-4">Package Details</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 md:mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 border-b pb-10">
              <div>
                <div className="flex items-center space-x-1 mb-3">
                  ...
                  <span className="text-xs font-bold text-gray-400 ml-2 uppercase tracking-widest">Verified Trip</span>
                </div>
              ...
              <div className="mt-8 md:mt-0">
                <button className="bg-[#00A1AB] text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-[#008a92] transition-all shadow-xl shadow-teal-500/20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              {[
                ...
                <div key={i} className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-sm font-black uppercase text-gray-400 tracking-widest mb-1">{item.label}</p>
            ...
            {/* Overview */}
            <div className="mb-16">
              <h3 className="text-3xl font-black text-gray-900 flex items-center mb-6">
              ...
              <div className="mb-16">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {pkg.highlights.map((highlight, i) => (
                    <li key={i} className="flex items-start text-lg font-bold text-gray-700 bg-gray-50 p-4 rounded-3xl border border-gray-100">
            ...
            <div className="mb-16 p-10 bg-[#0b2b2e] text-white rounded-[2.5rem] shadow-2xl">
              <h3 className="text-3xl font-black flex items-center mb-8">
                <span className="bg-[#00A1AB] w-1.5 h-6 rounded-full mr-4"></span>
                Inclusions & Exclusions
              </h3>
              <div className="grid md:grid-cols-2 gap-10">
                <div>
                  <h4 className="text-sm font-black uppercase tracking-[0.2em] text-[#7EC343] mb-6">What's Included</h4>
                  <ul className="space-y-4">
                    {(pkg.included || []).map((text, i) => (
                      <li key={i} className="flex items-start text-lg font-bold text-gray-300">
                ...
                <div>
                  <h4 className="text-sm font-black uppercase tracking-[0.2em] text-[#E95541] mb-6">What's Not Included</h4>
                  <ul className="space-y-4">
                    {(pkg.excluded || []).map((text, i) => (
                      <li key={i} className="flex items-start text-lg font-bold text-gray-400">
            ...
            {/* Itinerary Section */}
            <div className="mb-20">
              <h3 className="text-3xl font-black text-gray-900 flex items-center mb-8">
                <span className="bg-[#F4A622] w-1.5 h-6 rounded-full mr-4"></span>
                Detailed Itinerary
              </h3>
                  ...
                  <div key={i} className="border rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    >
                      <div className="flex items-center">
                        <span className="font-black text-[#00A1AB] text-lg mr-5 uppercase tracking-widest whitespace-nowrap">
                          {formatDay(item.day)}
                        </span>
                    ...
                    {activeAccordion === i && (
                      <div className="px-10 pb-8 pt-2 text-lg text-gray-600 font-medium bg-white leading-relaxed border-t border-gray-50">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-[#00A1AB] rounded-[2.5rem] p-10 text-white relative overflow-hidden group shadow-2xl">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="flex items-center space-x-4 bg-white/10 p-4 rounded-2xl hover:bg-white/20 transition-colors cursor-pointer border border-white/10">
                    ...
                    <div>
                      <p className="text-xs font-black uppercase opacity-60 tracking-widest">Call Expert</p>
                  ...
                  <div className="flex items-center space-x-4 bg-white/10 p-4 rounded-2xl hover:bg-white/20 transition-colors cursor-pointer border border-white/10">
                    <span className="text-2xl">📧</span>
                    <div>
                      <p className="text-xs font-black uppercase opacity-60 tracking-widest">Email Quote</p>
                      <span className="font-black text-lg">contact@yolo.com.np</span>
                    </div>
                  </div>
                </div>
                <button className="w-full mt-10 bg-[#F4A622] text-white py-4 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-[#d8911a] transition-all relative z-10 shadow-xl shadow-orange-900/20">
                  Enquire Now
                </button>
              </div>
              ...
              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 flex flex-col items-center text-center shadow-sm">
                ...
                <h5 className="font-black text-gray-900 uppercase text-xs tracking-widest mb-2">Official Operator</h5>
                <p className="text-sm text-gray-500 font-medium leading-relaxed">YOLO TOURISM is a licensed partner for Nepal, Bhutan, and Tibet.</p>
              </div>
            ...
            {relatedPackages.map((relatedPkg) => (
              ...
              >
                <div className="relative h-40 sm:h-48 md:h-56 overflow-hidden shrink-0">
                  ...
                  <div className="absolute top-4 left-4 md:top-5 md:left-5 bg-[#f58220] text-white px-3 py-1.5 md:px-4 md:py-1.5 rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl">
                    Similar Trip
                  </div>
                </div>
                <div className="p-4 md:p-6 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex items-center justify-between pt-3 md:pt-4 border-t border-gray-100">
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-black text-gray-400 tracking-widest mb-1">Duration</span>
                      <div className="flex items-center space-x-1.5 text-[#0b2b2e] font-black text-sm">
                        ...
                        <span>{relatedPkg.days} Days</span>
                      </div>
                    </div>
                    <div className="flex flex-col items-end">
                      <button className="bg-[#00A1AB] text-white px-6 py-2.5 rounded-lg font-black text-[10px] uppercase tracking-widest hover:bg-[#0b2b2e] transition-colors shadow-lg shadow-teal-500/20 whitespace-nowrap">
                        Explore
                      </button>
                    </div>
                  </div>
